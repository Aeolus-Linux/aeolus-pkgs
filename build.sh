...
sudo pacman -Syy --needed --noconfirm libmpdclient boost-libs perl-data-dump perl python-setuptools python2-setuptools sudo fakeroot mtdev gtk2-perl  tslib xorg-xset perl-file-desktopentry perl-gtk3 qt5-translations efibootmgr boost-libs python rsync fuse2 xorg-xauth libxinerama gtk3 libxrandr libxcursor 
