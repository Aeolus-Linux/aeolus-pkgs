DIR="$(pwd)"
echo test1
pacman -Syu --needed archiso sudo fakeroot git base-devel jq giflib libid3tag libqalculate rofi libwebp  imlib2 --noconfirm --noprogressbar 
...
pacman -Sy --needed sudo --noconfirm --noprogressbar
echo test2
